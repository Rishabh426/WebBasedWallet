...
export default function Hero() {
    ...
    return (
      <div className="flex flex-col items-center justify-center bg-gradient-to-b from-[#dbeafe] to-[#eff6ff] min-h-screen px-6 py-12">
        ...
        <div className="mt-10 flex gap-15 text-2xl font-serif">
          <button className="px-4 py-2 bg-blue-100 rounded">Solana</button>
          <button className="px-4 py-2 bg-blue-100 rounded">Eth</button>
        </div>
      </div>
    );
  }